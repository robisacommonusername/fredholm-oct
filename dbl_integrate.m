...
function [I,err_est] = dbl_integrate(f,xa,xb,ya,yb)
	...
	[xx,yy] = meshgrid(pts_g7_x,pts_g7_y);
	f_g7 = arrayfun(f,xx,yy);
	...
	[xx,yy] = meshgrid(pts_k15_x,pts_g7_y);
	K15 = K15 + weights_k15_gauss_y*arrayfun(f,xx,yy)*weights_k15_extra_x';
	[xx,yy] = meshgrid(pts_k15_x,pts_k15_y);
	K15 = K15 + weights_k15_extra_y*arrayfun(f,xx,yy)*weights_k15_extra_x';
	[xx,yy] = meshgrid(pts_g7_x,pts_k15_y);
	K15 = K15 + weights_k15_extra_y*arrayfun(f,xx,yy)*weights_k15_gauss_x';
