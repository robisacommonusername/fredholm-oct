...
function [I,err_est] = dbl_integrate_interpolate_irregular(xf,yf,f,xa,xb,ya,yb)
	...
	f_g7 = griddata(xf,yf,f,xxq,yyq,'linear'); %Would use cubic, but ictave hasn't implemented it yet
	...
	K15 = K15 + weights_k15_gauss_y*griddata(xf,yf,f,xxq,yyq,'linear')*weights_k15_extra_x';
	[xxq,yyq] = meshgrid(pts_k15_x,pts_k15_y);
	K15 = K15 + weights_k15_extra_y*griddata(xf,yf,f,xxq,yyq,'linear')*weights_k15_extra_x';
	[xxq,yyq] = meshgrid(pts_g7_x,pts_k15_y);
	K15 = K15 + weights_k15_extra_y*griddata(xf,yf,f,xxq,yyq,'linear')*weights_k15_gauss_x';
