...
function [I,status] = dbl_integrate_adaptive_interpolate(xx,yy,f,xa,xb,ya,yb, varargin)
	...
	if (max_iters > 1)
		if (err > tol)
			mx = (xa+xb)/2;
			my = (ya+yb)/2;
			[I1,stat1] = dbl_integrate_adaptive(xx,yy,f,xa,mx,ya,my,tol/4,max_iters-1);
			[I2,stat2] = dbl_integrate_adaptive(xx,yy,f,mx,xb,ya,my,tol/4,max_iters-1);
			[I3,stat3] = dbl_integrate_adaptive(xx,yy,f,xa,mx,my,yb,tol/4,max_iters-1);
			[I4,stat4] = dbl_integrate_adaptive(xx,yy,f,mx,xb,my,yb,tol/4,max_iters-1);
